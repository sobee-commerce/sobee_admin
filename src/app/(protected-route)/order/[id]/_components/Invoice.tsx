...
import {IAddress, IOrder, IOrderItem, IProduct, IUser} from '@/lib/interfaces';
                ...
                <TableRow key={index}>
                  <TableCell>
                    <div className="flex gap-4">
                      ...
                      <Link
                        target="_blank"
                        href={CUSTOMER_ROUTES.PRODUCTS.ID.replace(
                          ':id',
                          product.slug!,
                        )}>
                        {product.name}
                  ...
                  <TableCell>
                    {formatCurrency(
                      orderItem.price * orderItem.amount -
                        product.discount! * orderItem.price,
                    )}
                  </TableCell>
                  <TableCell>
                    {formatCurrency(product.discount! * orderItem.price)}
                  </TableCell>
