...
import {EProductSize} from '@/lib/enums';
...
const VariantForm = ({displayPrice, variants, setVariants}: Props) => {
  ...
  const onAddColor = () => {
    cartesian(sizes, [
      ...colors,
      increaseColorHex(colors[colors.length - 1] || '#000000'),
    ]);
  };
  ...
  return (
    <div>
      <p className="mb-4 text-sm">
        Add variants for the product. You can add multiple variants for the
        product.
      </p>
      <div className="my-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex gap-2">
                      <Input
                        ...
                        endContent={'$'}
                        onValueChange={e =>
                          onVariantValueChange('price', index, e)
                        }
                      ...
                      <Input
                        ...
                        placeholder="5"
                        onValueChange={e =>
                          onVariantValueChange('amount', index, Number(e))
                        }
