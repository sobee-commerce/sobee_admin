...
import {IBrand, ICategory, IProduct} from '@/lib/interfaces';
...
const ProductCard = ({product}: {product: IProduct}) => {
  ...
  return (
    <Card
      className="h-full min-w-60 pb-8 transition-transform hover:scale-[1.008]"
      shadow="sm">
        ...
        <div className="flex flex-1 flex-col gap-2">
          ...
          <div className="mt-2 flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <RatingStars
                initialRating={product.ratingValue || 0}
                starClassName=""
                readOnly
              />
...
const BestSellerProducts = ({products}: {products: IProduct[]}) => {
  return (
    <div className="overflow-hidden rounded-lg border border-foreground-300 p-6 md:p-7 lg:col-span-1 lg:col-start-2 lg:row-start-5 2xl:col-span-4 2xl:col-start-auto 2xl:row-start-auto">
      ...
      {products.length == 0 ? (
        <div className="flex h-[calc(100%-60px)] items-center justify-center">
          <div className="flex flex-col items-center py-7">
            ...
            <div className="mb-1 pt-6 text-base font-semibold">
              No data found
            </div>
        ...
        <div className="px-20">
          <Swiper
            ...
            pagination={{
              ...
              bulletActiveClass:
                'dark:bg-primary-400 swiper-pagination-bullet-active',
            }}
