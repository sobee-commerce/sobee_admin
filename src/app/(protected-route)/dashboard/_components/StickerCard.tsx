    ...
    <div
      ...
      <div className="mb-auto flex w-full items-center justify-between">
        ...
        <div className="flex w-full flex-col text-end">
          <span className="mb-1 text-base font-normal text-slate-500 dark:text-slate-300">
            {title}
          </span>
          ...
          {isSpring ? (
            ...
            <span className="mb-2 text-2xl font-semibold text-gray-800 dark:text-gray-300">
              {value}
            </span>
          )}
        </div>
      ...
      {indicator === 'up' && (
        <span
          className="mb-12 inline-block text-sm font-semibold text-slate-500"
          style={{color: '#03D3B5'}}>
          <ArrowUp width="9px" height="11px" className="inline-block" />{' '}
          {indicatorText}
      ...
      {indicator === 'down' && (
        <span
          className="mb-12 inline-block text-sm font-semibold text-slate-500"
          style={{color: '#FC6687'}}>
          <ArrowDown width="9px" height="11px" className="inline-block" />{' '}
          {indicatorText}
          <span className="text-sm font-normal text-slate-500"> {note}</span>
        </span>
      )}
