import { fetchAllBrands, fetchAllCategories, fetchAllShippings, fetchAllTaxes } from "@/_actions"
import { APP_ROUTES } from "@/_constants"
import { IBrand, ICategory, IShipping, ITax } from "@/_lib/interfaces"
...
const page = async () => {
  ...
  return (
    <div className='space-y-6'>
      ...
      <Divider />
      <ProductForm brands={brands} categories={categories} shippingFees={shippingFees} taxes={taxes} />
    </div>
  )
}
